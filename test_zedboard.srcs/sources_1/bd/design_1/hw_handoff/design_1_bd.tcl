...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net NAND_GATE_0_and_OUT [get_bd_ports LD1] [get_bd_pins NAND_GATE_0/and_OUT]
  connect_bd_net -net NAND_GATE_0_nand_OUT [get_bd_pins NAND_GATE_0/nand_OUT] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net a_0_1 [get_bd_ports SW1] [get_bd_pins NAND_GATE_0/a]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports LD0] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net b_0_1 [get_bd_ports SW0] [get_bd_pins NAND_GATE_0/b]
